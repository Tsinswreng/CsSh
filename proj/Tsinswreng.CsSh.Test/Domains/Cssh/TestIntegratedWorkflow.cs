...
/// Declares the one-case, stateful CsSh Content workflow test.
public partial class TestCssh{
	...
	/// Creates test data beside the test entry, exercises Content conversions and CsSh APIs in order, then always removes it.
