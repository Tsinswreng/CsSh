...
public static partial class ShGlobal{
	...
	public static partial Command Cmd(str Command);
	public static partial Command Cmd(str Command, CommandOptions Options);
	public static partial Command Cmd(str Command, in CT Ct);
	public static partial Command Cmd(str Command, CommandOptions Options, CT Ct);
	...
	public static partial Command TryCmd(str Command);
	public static partial Command TryCmd(str Command, CommandOptions Options);
	public static partial Command TryCmd(str Command, in CT Ct);
	public static partial Command TryCmd(str Command, CommandOptions Options, CT Ct);
	...
	public static partial CommandExit Exe(str Command);
	public static partial CommandExit Exe(str Command, CommandOptions Options);
	public static partial Task<CommandExit> Exe(str Command, CT Ct);
	public static partial Task<CommandExit> Exe(str Command, CommandOptions Options, CT Ct);
	...
	public static partial CommandExit TryExe(str Command);
	public static partial CommandExit TryExe(str Command, CommandOptions Options);
	public static partial Task<CommandExit> TryExe(str Command, CT Ct);
	public static partial Task<CommandExit> TryExe(str Command, CommandOptions Options, CT Ct);
