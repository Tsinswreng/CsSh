...
public static partial class ShGlobal{
	...
	public static partial Command X(str Command){ return Sh.Cmd(Command); }
	public static partial Command X(str Command, CommandOptions Options){ return Sh.Cmd(Command, Options); }
	public static partial Command X(str Command, in CT Ct){ return Sh.Cmd(Command, Ct); }
	public static partial Command X(str Command, CommandOptions Options, CT Ct){ return Sh.Cmd(Command, Options, Ct); }
	public static partial Command TryX(str Command){ return Sh.TryCmd(Command); }
	public static partial Command TryX(str Command, CommandOptions Options){ return Sh.TryCmd(Command, Options); }
	public static partial Command TryX(str Command, in CT Ct){ return Sh.TryCmd(Command, Ct); }
	public static partial Command TryX(str Command, CommandOptions Options, CT Ct){ return Sh.TryCmd(Command, Options, Ct); }
